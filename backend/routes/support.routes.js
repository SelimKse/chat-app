...
import { supportCreateLimiter, supportMessageLimiter } from "../middleware/rateLimit.middleware.js";
import {
  createTicket,
  listMyTickets,
  getMyTicketById,
...
router.post("/", supportCreateLimiter, supportUpload.array("attachments", 5), createTicket);
router.get("/my", listMyTickets);
router.get("/my/:ticketId", getMyTicketById);
router.post("/my/:ticketId/messages", supportMessageLimiter, supportUpload.array("attachments", 5), addMessageToMyTicket);
...
router.post("/admin/:ticketId/reply", supportMessageLimiter, supportUpload.array("attachments", 5), replyTicketAdmin);
